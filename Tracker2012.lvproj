...
The Single-Board RIO target contains a VI that demonstrates how to use the Starter Kit API with a real robot.</Property>
	...
	<Property Name="varPersistentID:{18E58FAF-1814-4288-B5DF-9B1B89A34661}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Modulus/output high</Property>
	<Property Name="varPersistentID:{1C0403C8-2844-48CB-BE82-ED867E5DBB21}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Modulus/derivative time (Td, min)</Property>
	...
	<Property Name="varPersistentID:{2436E52A-C507-4207-8E5D-CB00858EDB8D}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Modulus/dt out (s)</Property>
	<Property Name="varPersistentID:{26649DE4-6B6B-460B-A7DC-E204E789944A}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Argument/setpoint</Property>
	<Property Name="varPersistentID:{2BDE3153-75B5-460C-B86E-0070ED9D5800}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Argument/output</Property>
	<Property Name="varPersistentID:{2D6DB7E4-4E79-4EDB-BD59-B5B25B8004DC}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Argument/process variable</Property>
	...
	<Property Name="varPersistentID:{475DA425-08C6-4E33-ACDF-01FB8396DC29}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Argument/auto? (T)</Property>
	...
	<Property Name="varPersistentID:{4BD308D6-5083-4A42-843C-B0355269A15D}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Argument/proportional gain (Kc)</Property>
	...
	<Property Name="varPersistentID:{4DD399B0-4A4E-4C6B-8F14-2A5A0CC1FBB1}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Modulus/error out</Property>
	<Property Name="varPersistentID:{527304DD-211E-4353-A78D-C714962C66EB}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Modulus/reinitialize? (F)</Property>
	...
	<Property Name="varPersistentID:{5A26DAFE-7EA7-4FA5-AAA3-2D74FFFE0594}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Modulus/beta</Property>
	<Property Name="varPersistentID:{5DA4626A-2EA5-45D3-AE32-7D438A19F66B}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Argument/output low</Property>
	<Property Name="varPersistentID:{602CD4E6-D5B3-4490-9520-A7A1A3CB8C8F}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Modulus/proportional gain (Kc)</Property>
	<Property Name="varPersistentID:{63CA56B0-90E1-403D-A13D-6F368FCFBDDE}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Argument/derivative time (Td, min)</Property>
	<Property Name="varPersistentID:{63F9FE7B-72F8-4BBB-A13A-8756BD407AE4}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Modulus/integral time (Ti, min)</Property>
	...
	<Property Name="varPersistentID:{68B4A0F5-81F0-4A7A-B73B-F10FDBDD85F0}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Argument/dt out (s)</Property>
	...
	<Property Name="varPersistentID:{7A74815B-1BBF-4D36-AD36-B3DD2F4A5A93}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Argument/setpoint high</Property>
	<Property Name="varPersistentID:{810D8FB7-2581-4CD8-90C6-8401FC2F02EF}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Argument/manual control</Property>
	<Property Name="varPersistentID:{8A2D6736-2B41-4D70-8C1D-D79B6BD9BD92}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Argument/dt (s)</Property>
	<Property Name="varPersistentID:{8C1E9E5B-5853-4BEF-9FB9-0F42096D7B96}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Argument/linearity</Property>
	<Property Name="varPersistentID:{926983E7-38AA-4CA3-AA45-9F6798AB746B}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Argument/error out</Property>
	...
	<Property Name="varPersistentID:{9DA806D8-0D13-49E6-B0EB-BA840737F4B1}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Argument/beta</Property>
	<Property Name="varPersistentID:{A0074F14-E126-4154-9ADF-9E06922CB159}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Modulus/error in</Property>
	<Property Name="varPersistentID:{A6869748-FC5B-4739-94E6-0D5A9019B5AA}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Modulus/output low</Property>
	<Property Name="varPersistentID:{A99827FA-B548-4012-9A20-FA8DD1BA129E}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Modulus/setpoint high</Property>
	<Property Name="varPersistentID:{A9A34CF7-BA62-4692-BACA-8F31F1670BDA}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Argument/output high</Property>
	<Property Name="varPersistentID:{AC0D8679-F213-411D-9476-D1BEF34AF0E2}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Argument/setpoint low</Property>
	...
	<Property Name="varPersistentID:{B9A2A918-C6B5-466A-9A76-8F26CF2A9F07}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Argument/error in</Property>
	<Property Name="varPersistentID:{BBE60663-691B-41F1-B80D-D4D064514547}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Modulus/manual control</Property>
	<Property Name="varPersistentID:{C1AD27C1-5536-4927-A821-4BCC72FA09BF}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Modulus/setpoint low</Property>
	<Property Name="varPersistentID:{C2B7EC3F-EC0B-402E-B986-3DAA41BEC765}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Modulus/auto? (T)</Property>
	...
	<Property Name="varPersistentID:{CF93927A-690F-4058-A560-BA3F8D13153C}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Argument/integral time (Ti, min)</Property>
	...
	<Property Name="varPersistentID:{E308248A-72BE-442E-A999-65FDE7A3BA2F}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Modulus/dt (s)</Property>
	<Property Name="varPersistentID:{E42BD5E7-6322-463C-9D0A-74C7995F1637}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Modulus/linearity</Property>
	<Property Name="varPersistentID:{EDD14448-B493-437D-B98F-E50298DF5F40}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Modulus/process variable</Property>
	<Property Name="varPersistentID:{F1BC30FD-48EC-4B98-BADF-583E4EFA9501}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Modulus/setpoint</Property>
	<Property Name="varPersistentID:{F368AB34-9A01-4F0C-B545-85888F93E8B5}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Argument/reinitialize? (F)</Property>
	...
	<Property Name="varPersistentID:{FF7FC1A9-FE2A-4A45-A1C1-38CD994C361A}" Type="Ref">/Starter Kit 2.0 sbRIO/Robot_Main.vi/PID - Modulus/output</Property>
